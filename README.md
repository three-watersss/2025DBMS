...
-text
```bash
create table test_text_table(id int, info text);
insert into test_text_table values (1,'this is a very very long string');
insert into test_text_table values (2,'this is a very very long string2');
insert into test_text_table values (3,'this is a very very long string3');

select * from test_text_table;
...
2. INSERT RECORDS
insert into t_order_by values(3, 1.0, 'a'),(1, 2.0, 'b'),(4, 3.0, 'c'),(3, 2.0, 'c'),(3, 4.0, 'c'),(3, 3.0, 'd'),(3, 2.0, 'f');
