...
RC PhysicalPlanGenerator::create_plan(InsertLogicalOperator &insert_oper, unique_ptr<PhysicalOperator> &oper, Session* session)
{
  ...
  InsertPhysicalOperator *insert_phy_oper = new InsertPhysicalOperator(table, std::move(tuples));
...
RC PhysicalPlanGenerator::create_plan(UpdateLogicalOperator &update_oper, std::unique_ptr<PhysicalOperator> &oper,Session* session)
{
...
RC PhysicalPlanGenerator::create_plan(OrderByLogicalOperator &order_by_oper, std::unique_ptr<PhysicalOperator> &oper,Session* session)
{
  ...
  oper = unique_ptr<PhysicalOperator>(new OrderByPhysicalOperator(order_by_oper.orders()));
